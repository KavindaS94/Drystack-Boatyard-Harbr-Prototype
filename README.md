...
4. **Dry stack: berth → rack → water** — Osprey on **A10** → **Send to Dry stack** DS5 (free berth) → **Add task** Launch → **Launch** tab Start → Done → **Invoice Lift + Launch** (one draft, Marina). You can still invoice after **Move** back to A10.
